...
function toDeploylessCallViaFactoryData(parameters: {
  data: Hex; factory: Address; factoryData: Hex; to: Address
}) {
...
type StateOverride = Array<
  {
    ...
    | { /** Overrides INDIVIDUAL slots in the account storage */ stateDiff?: StateMapping | undefined }
  >
>
```
...
export const DEFAULT_SCRIPT_ADDRESS =
  '0xcD360FfAC9818c4396Aa6F4807EBfA72C4B3f530' as const
...
const { results } = await client.simulateCalls({
  ...
  stateOverrides: [                      // plural! top-level
